...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gruut-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14165&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gruut-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gruut` can be installed with:

```
conda install gruut
```

It is possible to list all of the versions of `gruut` available on your platform with:
